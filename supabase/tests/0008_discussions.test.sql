...
insert into public.courses(id, teacher_id, title) values ('11111111-1111-1111-1111-111111111112','11111111-1111-1111-1111-111111111111','Discussion Test Course');
insert into public.cohorts(id, course_id, teacher_id, title, start_date, end_date, timezone)
values ('11111111-1111-1111-1111-111111111113','11111111-1111-1111-1111-111111111112','11111111-1111-1111-1111-111111111111','Discussion Test Cohort','2026-01-01','2026-02-01','UTC');
insert into public.discussion_topics(id, cohort_id, author_id, title, body_markdown)
values ('11111111-1111-1111-1111-111111111114','11111111-1111-1111-1111-111111111113','11111111-1111-1111-1111-111111111111','Topic','Body');
