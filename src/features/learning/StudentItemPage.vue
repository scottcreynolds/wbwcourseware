...
const item=ref<CohortItem|null>(null),resources=ref<CourseItemResource[]>([]),outline=ref<LearningOutline|null>(null),loading=ref(true),errorMessage=ref<string|null>(null)
