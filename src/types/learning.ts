...
export type LearningItemDetail={id:string;cohortId:string;kind:CurriculumItemKind;title:string;bodyMarkdown:string;publicationStatus:PublicationStatus;dueAt:string|null}
