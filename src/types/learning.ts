...
export type LearningOutline={cohort:{id:string;title:string;courseId:string;startDate:string;endDate:string;timezone:string};course:{title:string;branding:Record<string,unknown>};modules:LearningModule[]}
