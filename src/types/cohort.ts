...
export type Cohort = { id:string; course_id:string; teacher_id:string; title:string; start_date:string; end_date:string; timezone:string; status:CohortStatus; created_at:string; updated_at:string }
