...
describe('course module visibility',()=>{it('supports manual and scheduled release',()=>{expect(visible('manual',null,null,'2026-01-01')).toBe(false);expect(visible('manual','2026-01-01',null,'2026-01-01')).toBe(true);expect(visible('scheduled',null,'2026-01-02','2026-01-01')).toBe(false);expect(visible('scheduled',null,'2026-01-01','2026-01-02')).toBe(true)})})
